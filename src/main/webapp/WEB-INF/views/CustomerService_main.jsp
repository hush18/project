...
<title>고객센터 메인</title>
<link href="css/CustomerService_main.css" rel="stylesheet" type="text/css" />
			...
			<div class="sub_boss_ej" style="display:flex;">
				<div class="category_ej">
					<div class="category_FAQ_ej">
						<h2><a href="CustomerService_main.do">고객센터</a></h2>
						...
						<div class=FAQ_TOP_2_ej>
							...
							<div class="faqList_ej">
								...
								<div class="top_content_ej" id="1" style="display: none;">
									<p>반디앤루니스 회원가입은 무료이며,  메인화면 상단의 [회원가입]을 클릭하시면 안내되는 화면에 따라 회원가입이 가능합니다.
									반디앤루니스는 회원 유형별로 가입절차에 차이가 있으니, 해당하시는 유형을 선택하시어 회원가입을 해주시기 바랍니다.
									회원가입시 제공하신 개인정보는 반디앤루니스 서비스에 이용되며, 그 이외 용도로는 절대 사용하지 않습니다.</p>
								</div>
								<div class="number2_ej">
									<a href="javascript:openContent('2');" id="toggle">파라메타는 카테고리(고유번호)와 게시물번호</a>
								</div>
