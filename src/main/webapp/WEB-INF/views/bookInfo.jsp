...
<link href="css/bookInfo.css" type="text/css" rel="stylesheet"/><!-- 제민(책정보 스타일) -->
				...
				<div class="book_info_jm">
					...
					<div class="book_area_button_jm">
						<div class="quantity_div_jm">
							<label>수량</label>
							<input id="quantity_value_jm_1" class="quantity_input_jm" type="text" size="1" value="1">
...
인생에서 가장 빛나는 순간은 어쩌면 자신이 원하지 않는 곳에서, 예상치 못한 일로 맞이하게 되는 수도 있다. 주인공 준하는 여느 평범한 한국의 초등학생들과 다름없는 시간들을 보내고 있다. 『톰 소여의 모험』 『로빈슨 크루소』 같은 모험 가득한 책을 좋아하고, 언젠가는 자신도 모험하는 날을 꿈꾸고 상상해 왔지만 느닷없이 찾아온 미국행 소식에 준하는 어리둥절할 뿐이다. 엄마 일 때문에 가게 된 낯선 땅 미국, 그것도 너무나도 생소한 ‘몰린’이라는 곳에서는 앞으로 어떤 일들이 펼쳐질까?
						...
						<div class="info_writer_jm">
							<div>저자</div>
							김아영, 서영아
글을 쓴 김아영은 모험가, 탐험가를 꿈꿨다. 지금도 아무도 찾지 않는 길, 낯선 길을 보면 가슴이 설렌다. 인간에 대해 알고 싶어 연극을 했고 방송, 광고 등에서 목소리로 연기하는 일도 했다. 『난생처음 히치하이킹』으로 제13회 마해송문학상을 받으며 작가로서 첫 발을 내딛게 되었다.

그림을 그린 서영아는 1976년 서울에서 태어나 한국예술종합학교 조형예술과를 졸업했다. 에너지 넘치는 일곱 살 딸을 키우며 책에 그림을 그리고 있다. 그린 책으로 『구멍 난 벼루』 『진돗개 보리』 『어떤 아이가』 『밥상을 차리다』 『해리엇』 『드림 하우스』 등이 있다. 
						</div>
						<div class="info_writer_otherBook_jm">
							<div>저자의 다른 책<a href="">더보기</a></div>
					...
					<div class="info_refund_jm">
						<div>상품 설명에 반품/ 교환 관련한 안내가 있는 경우 그 내용을 우선으로 합니다. (업체 사정에 따라 달라질 수 있습니다)</div>
						<div class="refund_centent">
							<div>
								<div>환불/교환 방법</div><div>홈 > 고객센터 > 자주찾는질문 “반품/교환/환불” 안내 참고 또는 1:1상담게시판</div>
							</div>
							<div>
								<div>반품/교환 가능 기간</div><div>반품,교환은 배송완료 후 7일 이내, 상품의 결함 및 계약내용과 다를 경우 문제발견 후 30일 이내에 신청가능</div>
							</div>
							<div>
								<div>반품/교환 비용</div><div>변심 혹은 구매착오의 경우에만 반송료 고객 부담(별도 지정 택배사 없음)</div>
							</div>
							<div>
								<div>반품/교환 불가 사유</div>
								<div>
									<ul>
										...
										<li>그밖에 월간지, 화보집, 사진집, 그림도감, 시집류, 중고학습서,  만화, 입시자료, 여성실용서적 등(파본/훼손/오발송 상품을 제외)</li>
									</ul>
								</div>
							</div>
							<div>
								<div>소비자 피해보상<br>환불지연에 따른 배상</div>
								<div>
									<ul>
